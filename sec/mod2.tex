...
\end{tikzcd}
\]
The map \(\Delta^t_*\) is linear since the cross term \(v \ot w + w \ot v\) vanishes as it is a norm class. %Not exactly, but almost. I think this is enough words for p=2, but for odd p a more explicit proof would be better.
