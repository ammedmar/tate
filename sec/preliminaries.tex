...
\[
W^\vee_p = \cdots \xla{- N} R\set{e_3^\vee}\xla{T^\vee} R\set{e_2^\vee} \xla{- N} R\set{e_1^\vee} \xla{T^\dd } R\set{e_0^\vee},
\]
where $T^\dd= (\rho^{-1}-1)$, and $e_i^\dd$ has degree $-i$.
...
\[
 \cdots \xla{T^\dd} R\set{e_2^\vee} \xla{-N} R\set{e_{1}^\vee} \xla{T^\dd} R\set{e_0^\vee} \xla{N} R\set{e_0} \xla{T} R\set{e_1} \xla{N} \cdots
\]
...
\[
 \cdots \xla{T^\dd} R\set{e_{-2}} \xla{-N} R\set{e_{-1}} \xla{T^\dd} R\set{e_0} \xla{N} R\set{e_1} \xla{T} R\set{e_2} \xla{N} \cdots
\]
