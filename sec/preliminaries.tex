...
\begin{remark}\label{rcan}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node (00) at (-5,-3){\(\sH(T_pV)\)};
			%
			\node (1) at (0,3){\((\sH V \wedge_{\bS} \overset{p}{\cdots} \wedge_{\bS} \sH V)^{t\cyc_p}\)};
			\node (2) at (0,1){\((\sH V \ot_{\sH \Fp} \overset{p}{\cdots} \ot_{\sH \Fp} \sH V)^{t\cyc_p}\)};
			\node (3) at (0,-1){\(\left(\sH(V \ot_\Fp \overset{p}{\cdots} \ot_\Fp V)\right)^{t\cyc_p}\)};
			\node (4) at (0,-3){\(\sH\left((V \ot_\Fp \overset{p}{\cdots} \ot_\Fp V)^{t\cyc_p}\right)\)};
			%
